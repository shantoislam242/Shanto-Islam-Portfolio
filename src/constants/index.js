...
const projects = [
  ...
  {
    name: "Pocket Planet - Marker Based AR Interactive Animal Book",
    description:
      "A marker-based AR mobile application designed around an animal-themed book for kids. By scanning book images, users can visualize animated 3D animal models in real time. The app includes interactive controls and sound effects to make learning more engaging, fun, and immersive for children.",
    layout: "horizontal",
    tags: [
      {
        name: "Unity",
